...
class GoogleSheets():
    ...
    def authorize_access(self):
        ...
        # credentials_json = os.getenv(self.credentials_json_env_var)
        # if credentials_json:
        ...
        #         self.path_credentials_file, scopes=scope)
        self.credentials = ServiceAccountCredentials.from_json_keyfile_name(
            self.path_credentials_file, scope)
        self.gc = gspread.authorize(self.credentials)

    # --------------------------------------------------
    def to_google_sheets(self, df: pd.DataFrame, spreadsheet_key: str, wks_name: str = "Hoja 1"):
