# src/stretegies/routes/option_bear_spread.py
...
option_bear_spread_router = APIRouter(
    prefix="/" + STRATEGY_NAME, tags=["Strategies - Option Bear Spread"]
)


@option_bear_spread_router.post("/start", response_model=dict)
async def start_option_bear_spread(
...
@option_bear_spread_router.get("/dataframe", response_model=list[OptionSpreadSummary])
