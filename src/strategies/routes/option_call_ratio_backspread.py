# src/stretegies/routes/option_call_ratio_backspread.py
...
STRATEGY_NAME = OPTION_CALL_RATIO_BACKSPREAD_NAME

option_call_ratio_backspread_router = APIRouter(
    prefix="/" + STRATEGY_NAME, tags=["Strategies - Option Call Ratio Backspread"]
)


@option_call_ratio_backspread_router.post("/start", response_model=dict)
async def start_option_call_ratio_backspread(
    ...
    strategy = OptionCallRatioBackspreadService(
...
@option_call_ratio_backspread_router.get("/status", response_model=dict)
...
@option_call_ratio_backspread_router.post("/reset", response_model=dict)
...
@option_call_ratio_backspread_router.get(
