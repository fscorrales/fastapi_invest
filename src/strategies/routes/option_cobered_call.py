...
@option_cobered_call_router.post("/start", response_model=dict)
async def start_option_cobered_call(
...
@option_cobered_call_router.get("/status", response_model=dict)
...
@option_cobered_call_router.post("/reset", response_model=dict)
