...
async def get_instruments_by_cficode(
    ...
    params: InstrumentsByCFICodeParams,
    url: str = None,
...
async def main():
    ...
    args = get_args()
    params = InstrumentsByCFICodeParams(CFICode=args.cficode)
...
if __name__ == "__main__":
    asyncio.run(main())
    # From /fastapi_invest
    # python -m src.primary.handlers.instruments_by_cficode -c ESXXXX
    # poetry run python -m src.primary.handlers.instruments_by_cficode -c ESXXXX -l
